...
function(e) {
    ...
    c = {
        ...
        unset: function(e, t) {
            var i = c.count(e);
            if (i) {
                if (1 === i) return c.data[e].content = [],
                c.data[e].config = [],
                void(c.data[e].tags = []);
                c.data[e].content[t] = null,
                c.data[e].config[t] = null,
                c.data[e].tags[t] = null
            }
        },
        out: function(e) {
            var t, i = "",
    ...
    _ = '<div class="close fileinput-remove">&times;</div>\n',
    b = '<i class="glyphicon glyphicon-file kv-caption-icon"></i>',
    C = '<div tabindex="500" class="form-control file-caption {class}">\n   <div class="file-caption-name"></div>\n</div>\n',
    x = '<button type="{type}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</button>',
    y = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>',
    T = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>',
    F = '<div id="' + i + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + i + 'Label"></div>',
    k = '<div class="modal-dialog modal-lg" role="document">\n  <div class="modal-content">\n    <div class="modal-header">\n      <div class="kv-zoom-actions pull-right">{toggleheader}{fullscreen}{borderless}{close}</div>\n      <h3 class="modal-title">{heading} <small><span class="kv-zoom-title"></span></small></h3>\n    </div>\n    <div class="modal-body">\n      <div class="floating-buttons"></div>\n      <div class="kv-zoom-body file-zoom-content"></div>\n{prev} {next}\n    </div>\n  </div>\n</div>\n',
    E = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {percent}%\n     </div>\n</div>',
    $ = " <br><samp>({sizeText})</samp>",
    S = '<div class="file-thumbnail-footer">\n    <div class="file-footer-caption" title="{caption}">{caption}{size}</div>\n    {progress} {actions}\n</div>',
    I = '<div class="file-actions">\n    <div class="file-footer-buttons">\n        {upload} {delete} {zoom} {other}    </div>\n    {drag}\n    <div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>\n    <div class="clearfix"></div>\n</div>',
    P = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n',
    D = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>',
    z = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>',
    A = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>',
    U = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-template="{template}"',
    ...
    me = function(t, i) {
        var a = this;
        a.$element = e(t),
        a._validate() && (a.isPreviewable = u(), a.isIE9 = s(9), a.isIE10 = s(10), a.isPreviewable || a.isIE9 ? (a._init(i), a._listen()) : a.$element.removeClass("file-loading"))
    },
    me.prototype = {
        constructor: me,
        _init: function(t) {
        ...
        _addError: function(e) {
            var t = this,
            i = t.$errorContainer;
            e && i.length && (i.html(t.errorCloseButton + e), d(i.find(".kv-error-close"), "click",
            function() {
                i.fadeOut("slow")
            }))
        },
        ...
        _showUploadError: function(e, t, i) {
            ...
            return 0 === n.find("ul").length ? a._addError("<ul>" + l + "</ul>") : n.find("ul").append(l),
            n.fadeIn(800),
            a._raise(r, [t, e]),
        ...
        _parseError: function(t, i, a) {
            ...
            return n.cancelling && n.msgUploadAborted && (r = n.msgUploadAborted),
        ...
        _parseFilePreviewIcon: function(t, i) {
            var a, n, r = this,
            l = r.previewFileIcon;
            return i && i.indexOf(".") > -1 && (n = i.split(".").pop(), r.previewFileIconSettings && r.previewFileIconSettings[n] && (l = r.previewFileIconSettings[n]), r.previewFileExtSettings && e.each(r.previewFileExtSettings,
            function(e, t) {
        ...
        _listen: function() {
            ...
            d(e(document), "webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange",
            function() {
        ...
        _initClickable: function() {
            var t, i = this;
            i.isClickable && (t = i.isUploadable ? i.$dropZone: i.$preview.find(".file-default-preview"), g(t, "clickable"), t.attr("tabindex", -1), d(t, "click",
            function(a) {
                var n = e(a.target);
        ...
        _zoneDragEnter: function(t) {
            ...
            return i._zoneDragDropInit(t),
            i.isDisabled || !a ? (t.originalEvent.dataTransfer.effectAllowed = "none", void(t.originalEvent.dataTransfer.dropEffect = "none")) : void g(i.$dropZone, "file-highlighted")
        },
        ...
        _zoneDrop: function(e) {
            var t = this;
            e.preventDefault(),
            t.isDisabled || ae(e.originalEvent.dataTransfer.files) || (t._change(e, "dragdrop"), t.$dropZone.removeClass("file-highlighted"))
        },
        ...
        _listenModalEvent: function(e) {
            ...
            function(n) {
                ...
                t._raise("filezoom" + e, a(n)),
                "shown" === e && (l.removeClass("active").attr("aria-pressed", "false"), r.removeClass("active").attr("aria-pressed", "false"), i.hasClass("file-zoom-fullscreen") && (t._maximizeZoomDialog(), pe() ? r.addClass("active").attr("aria-pressed", "true") : l.addClass("active").attr("aria-pressed", "true")))
            })
        },
        _initZoom: function() {
            var t, a = this,
        ...
        _resizeZoomDialog: function(e) {
            ...
            if (i.hasClass("file-zoom-fullscreen")) ue(!1),
            e ? a.hasClass("active") || (i.removeClass("file-zoom-fullscreen"), t._resizeZoomDialog(!0), n.hasClass("active") && n.removeClass("active").attr("aria-pressed", "false")) : a.hasClass("active") ? a.removeClass("active").attr("aria-pressed", "false") : (i.removeClass("file-zoom-fullscreen"), t.$modal.find(".kv-zoom-body").css("height", t.zoomModalHeight));
            else {
        ...
        _setZoomContent: function(t, i) {
            ...
            a = t.find(".kv-file-content"),
            r = a.length ? a.html() : "",
            l = t.find(".file-footer-caption").text() || "",
            m.find(".kv-zoom-title").html(l),
            o = m.find(".kv-zoom-body"),
            i ? (p = o.clone().insertAfter(o), o.html(r).hide(), p.fadeOut("fast",
            function() {
                o.fadeIn("fast"),
                p.remove()
            })) : o.html(r),
            c = u.previewZoomSettings[n],
            c && (s = o.find(".kv-preview-data"), g(s, "file-zoom-detail"), e.each(c,
            function(e, t) {
                s.css(e, t),
                (s.attr("width") && "width" === e || s.attr("height") && "height" === e) && s.removeAttr(e)
            })),
            m.data("previewId", f),
            d(v, "click",
            function() {
            ...
            function() {
                ...
                n = function(e) {
                    ...
                    a = u.zoomModalHeight;
                    m.hasClass("file-zoom-fullscreen") && (a = i.outerHeight(!0), e || (a -= t.outerHeight(!0))),
            ...
            function(e) {
                ...
                37 !== t || v.attr("disabled") || u._zoomSlideShow("prev", f),
                39 !== t || h.attr("disabled") || u._zoomSlideShow("next", f)
            })
        },
        _zoomPreview: function(e) {
            ...
            t = e.closest(".file-preview-frame"),
            i._setZoomContent(t),
            i.$modal.modal("show"),
            i._initZoomButtons()
        },
        ...
        _initPreviewActions: function() {
            ...
            t.$preview.find(".kv-file-remove").each(function() {
                ...
                l = n.data("key");
                if (!ae(r) && void 0 !== l) {
                    var o, s, p, u, f = n.closest(".file-preview-frame"),
                    m = c.data[t.id],
                    v = f.data("fileindex");
                    v = parseInt(v.replace("init_", "")),
                    p = ae(m.config) && ae(m.config[v]) ? null: m.config[v],
                    u = ae(p) || ae(p.extra) ? i: p.extra,
                    ...
                    o = e.extend(!0, {},
                    {
                        ...
                        beforeSend: function(e) {
                            t.ajaxAborted = !1,
                            t._raise("filepredelete", [l, e, u]),
                            t.ajaxAborted ? e.abort() : (g(f, "file-uploading"), g(n, "disabled"))
                        },
                        success: function(e, i, r) {
                            var o, d;
                            return ae(e) || ae(e.error) ? (c.unset(t.id, v), o = c.count(t.id), d = o > 0 ? t._getMsgSelected(o) : "", t._raise("filedeleted", [l, r, u]), t._setCaption(d), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow",
                            function() {
                                t._clearObjects(f),
                                f.remove(),
                                a(),
                                o || 0 !== t.getFileStack().length || (t._setCaption(""), t.reset())
                        ...
                        error: function(e, i, n) {
                            ...
                            s.jqXHR = e,
                            s.response = {},
                            t._showError(r, s, "filedeleteerror"),
                            f.removeClass("file-uploading"),
                            a()
                        }
                    },
        ...
        _initXhr: function(e, t, i) {
            ...
            function(e) {
                ...
                l = e.total;
                e.lengthComputable && (n = Math.ceil(r / l * 100)),
                t ? a._setAsyncUploadStatus(t, n, i) : a._setProgress(Math.ceil(n))
            },
            !1),
            e
        },
        ...
        _initUploadSuccess: function(t, i, a) {
            ...
            function() {
                o.fadeIn("slow").css("display:inline-block"),
        ...
        _initSuccessThumbs: function() {
            ...
            t.showPreview && t._getThumbs(".file-preview-success").each(function() {
                ...
                function() {
                    ...
                    function() {
                        i.remove(),
                        t.$preview.find(".file-preview-frame").length || t.reset()
                    })
                })
            })
        },
        ...
        _uploadSingle: function(t, i, a) {
            var n, r, l, o, s, d, p, u, f, m, v = this,
            ...
            v.formdata = w,
            v.showPreview && (r = e("#" + b + ":not(.file-preview-initial)"), o = r.find(".kv-file-upload"), s = r.find(".kv-file-remove"), e("#" + b).find(".file-thumb-progress").removeClass("hide")),
            0 === h || !_ || o && o.hasClass("disabled") || v._abort(C) || (m = function(e, t) {
                v.updateStack(e, void 0),
                v.uploadLog.push(t),
            ...
            u = function() {
                setTimeout(function() {
                    v.showPreview && (o.removeAttr("disabled"), s.removeAttr("disabled"), r.removeClass("file-uploading")),
                    a ? l() : (v.unlock(!1), v._clearFileInput()),
            ...
            f = function(n, l, o) {
                ...
                setTimeout(function() {
                    a && m(t, b),
                    v.uploadStatus[b] = 100,
                    v._setPreviewError(r, t),
                    e.extend(!0, C, v._getOutData(n)),
                    v._showUploadError(s, C)
                },
                100)
            },
        ...
        _uploadBatch: function() {
            ...
            t = function(t) {
                ...
                l.showPreview && l._getThumbs().each(function() {
                    ...
                    t.hasClass("file-preview-success") || (l._setThumbStatus(t, "Loading"), g(t, "file-uploading")),
                    i.attr("disabled", !0),
                    a.attr("disabled", !0)
                }),
            ...
            i = function(t, i, a) {
                ...
                ae(t) || ae(t.error) ? (l._raise("filebatchuploadsuccess", [n]), r(), l.showPreview ? (o.each(function() {
                    ...
                    return t.removeClass("file-uploading"),
                    a.removeAttr("disabled"),
                    i.removeAttr("disabled"),
                    0 === d.length ? void l._setPreviewError(t) : ( - 1 !== e.inArray(s, d) ? l._setPreviewError(t) : (t.find(".kv-file-upload").hide(), l._setThumbStatus(t, "Success"), l.updateStack(s, void 0)), void s++)
        ...
        _uploadExtraOnly: function() {
            ...
            n._abort(r) || (e = function(e) {
                ...
                r.data = t,
                r.xhr = e,
                n._abort(r) && (e.abort(), n._setProgressCancelled())
            },
            t = function(e, t, i) {
        ...
        _initFileActions: function() {
            ...
            t.showPreview && (t._initZoomButton(), t.$preview.find(".kv-file-remove").each(function() {
                ...
                d(l, "click",
                function() {
                    return r = t._raise("filepreremove", [s, p]),
                    r !== !1 && t._validateMinCount() ? (i = o.hasClass("file-preview-error"), de(o), void o.fadeOut("slow",
                    function() {
                        t.updateStack(p, void 0),
                        t._clearObjects(o),
                        o.remove(),
                        s && i && t.$errorContainer.find('li[data-file-id="' + s + '"]').fadeOut("fast",
                        function() {
                            e(this).remove(),
                            t._errorsExist() || t._resetErrors()
                        }),
                        t._clearFileInput();
                        ...
                        0 !== d || 0 !== l || u ? (a = l + d, n = a > 1 ? t._getMsgSelected(a) : r[0] ? t._getFileNames()[0] : "", t._setCaption(n)) : t.reset(),
                        t._raise("fileremoved", [s, p])
                    })) : !1
                })
        ...
        _getSize: function(e) {
            ...
            var i, a, n, r = this,
            l = r.fileSizeGetter;
            return "function" == typeof l ? n = l(e) : (i = Math.floor(Math.log(t) / Math.log(1024)), a = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], n = 1 * (t / Math.pow(1024, i)).toFixed(2) + " " + a[i]),
        ...
        _generatePreviewTemplate: function(e, t, i, a, n, r, l, o, s, d) {
            ...
            return d = d || n.slice(n.lastIndexOf("-") + 1),
            f = u._parseFilePreviewIcon(f, i),
            "text" === e || "html" === e ? (p = "text" === e ? oe(t) : t, c = f.replace(/\{previewId}/g, n).replace(/\{caption}/g, v).replace(/\{width}/g, g.width).replace(/\{height}/g, g.height).replace(/\{frameClass}/g, m).replace(/\{cat}/g, a).replace(/\{footer}/g, h).replace(/\{fileindex}/g, d).replace(/\{data}/g, p).replace(/\{template}/g, e)) : c = f.replace(/\{previewId}/g, n).replace(/\{caption}/g, v).replace(/\{frameClass}/g, m).replace(/\{type}/g, a).replace(/\{fileindex}/g, d).replace(/\{width}/g, g.width).replace(/\{height}/g, g.height).replace(/\{footer}/g, h).replace(/\{data}/g, t).replace(/\{template}/g, e),
            c
        },
        _previewDefault: function(t, i, a) {
            ...
            if (n.showPreview) {
                ...
                o.append("\n" + s),
                a === !0 && n.isUploadable && n._setThumbStatus(e("#" + i), "Error")
            }
        },
        ...
        _readFiles: function(t) {
            ...
            b = function(n, r, l, o) {
                ...
                return a._previewDefault(r, l, !0),
            ...
            i = function(e) {
                if (ae(n.attr("multiple")) && (m = 1), e >= m) return a.isUploadable && a.filestack.length > 0 ? a._raise("filebatchselected", [a.getFileStack()]) : a._raise("filebatchselected", [t]),
                d.removeClass("file-thumb-loading"),
                void c.html("");
                ...
                Z = ae(L) ? "": L.join(", ");
                if (ae(L) || (D = new RegExp("\\.(" + L.join("|") + ")$", "i")), P = P.toFixed(2), a.maxFileSize > 0 && P > a.maxFileSize) return T = a.msgSizeTooLarge.replace("{name}", I).replace("{size}", P).replace("{maxSize}", a.maxFileSize),
                void(a.isError = b(T, S, $, e));
                if (!ae(U) && ne(U)) {
                    for (y = 0; y < U.length; y += 1) F = U[y],
                    x = g[F],
                    k = void 0 !== x && x(S.type, I),
                    A += ae(k) ? 0 : k.length;
                    if (0 === A) return T = a.msgInvalidFileType.replace("{name}", I).replace("{types}", j),
                    void(a.isError = b(T, S, $, e))
                }
                ...
                s.onload = function(t) {
                    a._previewFile(e, S, t, $, z),
                    a._initFileActions()
                },
                s.onloadend = function() {
                    T = u.replace("{index}", e + 1).replace("{files}", m).replace("{percent}", 50).replace("{name}", I),
                    setTimeout(function() {
                        c.html(T),
                        a._updateFileDetails(m),
                        i(e + 1)
                    },
                    100),
                ...
                s.onprogress = function(t) {
                    if (t.lengthComputable) {
                        ...
                        a = Math.ceil(i);
                        T = u.replace("{index}", e + 1).replace("{files}", m).replace("{percent}", a).replace("{name}", I),
                        setTimeout(function() {
                            c.html(T)
                        },
                        100)
        ...
        _setProgress: function(e, t, i) {
            ...
            t = t || a.$progress,
            ae(r) || (t.html(r.replace(/\{percent}/g, n)), i && t.find('[role="progressbar"]').html(i))
        },
        _setFileDropZoneTitle: function() {
            ...
            t.isUploadable && t.showPreview && 0 !== i.length && !(t.getFileStack().length > 0) && t.dropZoneEnabled && (0 === i.find(".file-preview-frame").length && ae(t.defaultPreviewContent) && i.prepend('<div class="' + t.dropZoneTitleClass + '">' + a + "</div>"), t.$container.removeClass("file-input-new"), g(t.$container, "file-input-ajax-new"))
        },
        ...
        _getFileCount: function(e) {
            var t = this,
            i = 0;
            return t.validateInitialCount && !t.overwriteInitial && (i = c.count(t.id), e += i),
            e
        },
        ...
        _setPreviewError: function(e, t, i) {
            var a = this;
            void 0 !== t && a.updateStack(t, i),
            a.removeFromPreviewOnError ? e.remove() : a._setThumbStatus(e, "Error")
        },
        ...
        _validateAllImages: function() {
            ...
            if (o.loadedImages.length === o.totalImagesCount && (o._raise("fileimagesloaded"), o.resizeImage)) {
                for (l = o.isUploadable ? o._showUploadError: o._showError, e = 0; e < o.loadedImages.length; e++) t = o.loadedImages[e],
                i = t.img,
                a = t.thumb,
                n = t.pid,
                r = t.ind,
        ...
        _getResizedImage: function(e, t, i, a) {
            ...
            f.height = s;
            try {
                return m.drawImage(e, 0, 0, o, s),
                f.toBlob(function(e) {
                    l._raise("fileimageresized", [i, a]),
                    l.filestack[a] = e
                },
                t, l.resizeQuality),
                !0
        ...
        _setCaption: function(t, i) {
            ...
            s = o.getFileStack();
            if (o.$caption.length) {
                if (i) a = e("<div>" + o.msgValidationError + "</div>").text(),
                r = s.length,
                ...
                n = '<span class="' + o.msgValidationErrorClass + '">' + o.msgValidationErrorIcon + (ae(t) ? l: t) + "</span>";
                    ...
                    if (ae(t)) return;
                    a = e("<div>" + t + "</div>").text(),
                    n = o._getLayoutTemplate("fileIcon") + a
                }
                o.$caption.html(n),
                o.$caption.attr("title", a),
                o.$captionContainer.find(".file-caption-ellipsis").attr("title", a)
            }
        },
        ...
        _renderFileFooter: function(e, t, i, a) {
            ...
            return t = r._getSize(t),
            n = r.isUploadable ? p.replace(/\{actions}/g, r._renderFileActions(d, o, c, s, !1, !1, !1)).replace(/\{caption}/g, e).replace(/\{size}/g, t).replace(/\{width}/g, i).replace(/\{progress}/g, r._renderThumbProgress()).replace(/\{indicator}/g, u).replace(/\{indicatorTitle}/g, f) : p.replace(/\{actions}/g, r._renderFileActions(!1, !1, c, s, !1, !1, !1)).replace(/\{caption}/g, e).replace(/\{size}/g, t).replace(/\{width}/g, i).replace(/\{progress}/g, "").replace(/\{indicator}/g, u).replace(/\{indicatorTitle}/g, f),
        ...
        _renderFileActions: function(e, t, i, a, n, r, l, o) {
            ...
            return t && (u = d._getLayoutTemplate("actionDelete").replace(/\{removeClass}/g, b).replace(/\{removeIcon}/g, h.removeIcon).replace(/\{removeTitle}/g, h.removeTitle).replace(/\{dataUrl}/g, c).replace(/\{dataKey}/g, p)),
            ...
            i && (m = d._getLayoutTemplate("actionZoom").replace(/\{zoomClass}/g, h.zoomClass).replace(/\{zoomIcon}/g, h.zoomIcon).replace(/\{zoomTitle}/g, h.zoomTitle)),
            a && o && (s = "drag-handle-init " + h.dragClass, g = d._getLayoutTemplate("actionDrag").replace(/\{dragClass}/g, s).replace(/\{dragTitle}/g, h.dragTitle).replace(/\{dragIcon}/g, h.dragIcon)),
            v.replace(/\{delete}/g, u).replace(/\{upload}/g, f).replace(/\{zoom}/g, m).replace(/\{drag}/g, g).replace(/\{other}/g, w)
        },
        _browse: function(e) {
            var t = this;
            t._raise("filebrowse"),
            e && e.isDefaultPrevented() || (t.isError && !t.isUploadable && t.clear(), t.$captionContainer.focus())
        },
        _change: function(t) {
            var i = this,
            a = i.$element;
            ...
            var n, r, l, o, s, d, p = arguments.length > 1,
            u = i.isUploadable,
            f = 0,
            ...
            if (i.reader = null, i._resetUpload(), i._hideFileIcon(), i.isUploadable && i.$container.find(".file-drop-zone ." + i.dropZoneTitleClass).remove(), p) for (n = []; m[f];) o = m[f],
            o.type || o.size % 4096 !== 0 ? n.push(o) : w++,
            f++;
            else n = void 0 === t.target.files ? t.target && t.target.value ? [{
                name: t.target.value.replace(/^.+\\/, "")
            }] : [] : t.target.files;
            if (ae(n) || 0 === n.length) return u || i.clear(),
            i._showFolderError(w),
            void i._raise("fileselectnone");
            if (i._resetErrors(), d = n.length, l = i._getFileCount(i.isUploadable ? i.getFileStack().length + d: d), i.maxFileCount > 0 && l > i.maxFileCount) {
                if (!i.autoReplace || d > i.maxFileCount) return s = i.autoReplace && d > i.maxFileCount ? d: l,
                r = i.msgFilesTooMany.replace("{m}", i.maxFileCount).replace("{n}", s),
                i.isError = b(r, null, null, null),
            ...
            i.isPreviewable ? i._readFiles(n) : i._updateFileDetails(1),
            i._showFolderError(w)
        },
        _abort: function(t) {
            var i, a = this;
            ...
            i.abortMessage = a.ajaxAborted.message, a.cancel(), a._setProgress(100, a.$progress, a.msgCancelled), a._showUploadError(a.ajaxAborted.message, i, "filecustomerror"), !0) : !1
        },
        ...
        cancel: function() {
            ...
            a = i.ajaxRequests,
            n = a.length;
            if (n > 0) for (t = 0; n > t; t += 1) i.cancelling = !0,
            a[t].abort();
        ...
        clear: function() {
            var t, i = this;
            return i.$btnUpload.removeAttr("disabled"),
            i._getThumbs().find("video,audio,img").each(function() {
                de(e(this))
            }),
            i._resetUpload(),
            i.clearStack(),
            ...
            i._resetErrors(!0),
            i._raise("fileclear"),
            i._hasInitialPreview() ? (i._showFileIcon(), i._resetPreview(), i._initPreviewActions(), i.$container.removeClass("file-input-new")) : (i._getThumbs().each(function() {
                i._clearObjects(e(this))
            }), i.isUploadable && (c.data[i.id] = {}), i.$preview.html(""), t = !i.overwriteInitial && i.initialCaption.length > 0 ? i.initialCaption: "", i._setCaption(t), i.$caption.attr("title", ""), g(i.$container, "file-input-new"), i._validateDefaultPreview()),
        ...
        upload: function() {
            ...
            if (n.isUploadable && !n.isDisabled && (0 !== r || o)) {
                if (n._resetUpload(), n.$progress.removeClass("hide"), n.uploadCount = 0, n.uploadStatus = {},
                n.uploadLog = [], n.lock(), n._setProgress(2), 0 === r && o) return void n._uploadExtraOnly();
                ...
                n.uploadAsyncCount = n.getFileStack().length, t = 0; a > t; t++) n.uploadCache.content[t] = null,
                n.uploadCache.config[t] = null,
                n.uploadCache.tags[t] = null;
        ...
        destroy: function() {
            var e = this,
            i = e.$container;
            return i.find(".file-drop-zone").off(),
            e.$element.insertBefore(i).off(t).removeData(),
            i.off().remove(),
            e.$element
        },
        refresh: function(t) {
    ...
    e.fn.fileinput = function(t) {
        if (u() || s(9)) {
            ...
            switch (i.shift(), this.each(function() {
                ...
                l || (s && (c = e.fn.fileinputThemes[s] || {}), "en" === p || ae(e.fn.fileinputLocales[p]) || (d = e.fn.fileinputLocales[p] || {}), n = e.extend(!0, {},
                e.fn.fileinput.defaults, c, e.fn.fileinputLocales.en, d, o, r.data()), l = new me(this, n), r.data("fileinput", l)),
