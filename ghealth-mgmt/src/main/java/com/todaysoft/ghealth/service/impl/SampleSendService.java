            ...
            if(StringUtils.isNotEmpty(code)){
                ...
                try {
                    ...
                    if (listS.contains(order.getAgency().getId())){
                        ...
                        if(shortMessageCon.getSampleDelivered().getNotifyEnabled().equals("1")){
                            List<String> aa = shortMessageCon.getSampleDelivered().getNotifyTarget();
                            for (int a=0;a<aa.size();a++){
                                if(aa.get(a).equals("2")){
                                    result = restAPI.sendTemplateSMS(phone, "231666", new String[] {});
                                }
                            }
                        }
                    }else {
                ...
                if(shortMessageCon.getSampleDelivered().getNotifyEnabled().equals("1")){
                    ...
                    for (int a=0;a<aa.size();a++){
                        if (aa.get(a).equals("1")){
                            result = restAPI.sendTemplateSMS(phone, "231671", new String[] {orderTest.getNumber().toString()});
                        }
                    }
                }
            }else {
