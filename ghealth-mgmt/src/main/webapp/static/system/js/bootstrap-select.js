    ...
    createLi: function () {
      ...
      if (this.options.title && !this.multiple) {
        ...
        if (!this.$element.find('.bs-title-option').length) {
          ...
          // the selected item may have been changed by agencyAccount or programmatically before the bootstrap select plugin runs,
    ...
    keydown: function (e) {
      ...
      if ((/(13|32)/.test(e.keyCode.toString(10)) || (/(^9$)/.test(e.keyCode.toString(10)) && that.options.selectOnTab)) && isActive) {
        ...
        if (!that.options.liveSearch) {
          ...
          elem.focus();
          // Prevent screen from scrolling if the agencyAccount hit the spacebar
          e.preventDefault();
